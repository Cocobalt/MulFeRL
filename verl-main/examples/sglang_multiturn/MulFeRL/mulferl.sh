#!/bin/bash
# MulFeRL training launch script for the anonymous release.
# Run from the verl-main directory, or set PROJECT_DIR explicitly.
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.multi_turn.feedback_tool_name=calc_mulferl_feedback \
    +actor_rollout_ref.rollout.multi_turn.feedback_merge_tool_name=calc_mulferl_feedback \
    ...
    +algorithm.feedback_group_size=2 \
    +algorithm.fco_lambda=0.01 \
    +algorithm.fco_tau=0.005 \
    +algorithm.fco_margin=0.0 \
