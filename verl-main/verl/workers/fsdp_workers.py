...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # TODO: support random initialization and direct FSDP initialization.
        ...
        with init_context(), warnings.catch_warnings():
            ...
            # Some parameters may not use torch_dtype. Remove this after switching to FSDP2.
        ...
        if self._is_rollout and self.config.rollout.name == "hf":
            # TODO: auto_wrap_policy currently causes HFRollout to hang in Gemma.
    ...
    def generate_feedbacks(self, prompts: DataProto):
        ...
        The signature mirrors generate_sequences so the trainer can reuse the
        same DataProto flow. The rollout engine receives prompts and delegates
        the feedback-specific construction to the rollout implementation.
        """
        assert self._is_rollout
