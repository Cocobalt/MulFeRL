...
def _get_question_raw(ei):
    # ei 可能是 dict，也可能是 json string，也可能是 None
    if ei is None:
        return ""
...
class SGLangRollout(BaseRollout):
    ...
    def _build_feedback_prompts_from_failed_batch_by_group(
        ...
        **kwargs,
        ...
        feedback_prompts.non_tensor_batch["prompt_text"] = np.array(group_questions, dtype=object)  # ★ 关键：对齐到 num_groups
