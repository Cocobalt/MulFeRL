...
class MulFeRLTool(BaseTool):
    ...
    def __init__(self, config: dict, tool_schema: OpenAIFunctionToolSchema):
        ...
        self.judge_model = os.getenv("MULFERL_FEEDBACK_MODEL") or config.get("api_model") or "gpt-4o"
    ...
    async def _call_judge(
        ...
        try:
            ...
            feedback_text = search_text.strip() or content_wo_think.strip()
            return 0.0, feedback_text, extra_metrics

        except Exception as e:
            logger.exception("Error calling feedback provider via OpenAI-compatible API: %s", e)
            feedback_text = (
    ...
    def _system_prompt_group(self) -> str:
        ...
        return (
            ...
            "2. Where it first goes wrong (quote one or two lines): \"...\"\n"
